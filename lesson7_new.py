...
# Данная функция принимает градусы по фаренгейту и переводит в градусы по цельсию
...
f100_in_celsius = f_to_c()  # Получаем градусы по цельсию
print('Градус цельсия будет: ', f100_in_celsius)  # Выводим результат


# Работа в обратную сторону
# Данная функция принимает градусы по цельсию и переводит в градусы по фаренгейту
def c_to_f(c_temp):
...
c0_in_fahrenheit = c_to_f(
    f_to_c())  # Принимаем значение верхней функции f_to_c() и получаем результат в градусы по фаренгейту

print('Градус фаренгейта будет: ', c0_in_fahrenheit)  # Выводим результат
...
def analytic(maxy, med, miny, standart):
    if maxy - med > 5 * standart or med - miny > 5 * standart:
        ...
        return 'В ваших данных имеются выбросы и требуют пред обработки'
    else:
...
new_account1 = last_name[:5]  # Вашин
new_account2 = last_name[2] + last_name[5]  # шг
