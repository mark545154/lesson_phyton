...
# readline() Выводит строки по очерёдно. Сколько раз вызовите, столько строк и выдаст! В данном файле 4 строки
...
####################################################################
# Упражнение 1. Вспомним упражнение с Дмитрием. Напомним ее содержание:
