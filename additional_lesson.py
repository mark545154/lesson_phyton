...
###################################################################
# Решение Евгения Плеханова

# strana = input('Введите страну: ')
# nazvanie = input('ВВедите название: ')
# artikul = nazvanie [0 : 3] + strana
# familiya_avtora = input('Введите фамилию автора: ')
# imya_avtora = input('Введите имя автора: ')
# annot = input('Аннтотация: ')
#
# def magazin (strana, nazvanie, artikul, familiya_avtora, imya_avtora, annot):
#     return 'В продаже появилась новая книга. Название книги ' + nazvanie + ' Автор – ' + familiya_avtora + imya_avtora [0] + ' '+ annot
# print(magazin(strana, nazvanie, artikul, familiya_avtora, imya_avtora, annot))
